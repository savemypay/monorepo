...
AWS_S3_ACCESS_KEY_ID = os.getenv("AWS_S3_ACCESS_KEY", "")
...
# Rewards
REFERRAL_REWARD_POINTS = int(os.getenv("REFERRAL_REWARD_POINTS", os.getenv("REGISTER_REFERRAL_POINTS", "10")))
DAILY_LOGIN_STREAK_POINTS = int(os.getenv("DAILY_LOGIN_STREAK_POINTS", "5"))

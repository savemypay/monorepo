...
export default function Video() {
  return (
    <section id="video" className="relative px-6 py-12 md:py-25 md:pb-35 bg-slate-950 overflow-hidden">
      ...
      <div className="relative z-10 max-w-300 mx-auto grid grid-cols-1 gap-10 items-center">
        ...
        <div
          className={`rounded-2xl mt-5 lg:mt-10 ${REVEAL}`}
          data-reveal
          style={{ transitionDelay: "220ms" }}
        >
          <div className="relative w-full overflow-hidden rounded-lg border border-white/15 bg-black/40 pt-[56.25%]">
            <iframe

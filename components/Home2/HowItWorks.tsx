...
//         <div className="">
//           <h2 className={`text-[28px] md:text-[36px] lg:text-[48px] leading-tight font-medium mb-4 text-white ${REVEAL}`} data-reveal style={{ transitionDelay: "100ms" }}>
...
//           </h2>
//           <p className={`text-lg text-[#7A8CA3] leading-tight max-w-200 ${REVEAL}`} data-reveal style={{ transitionDelay: "200ms" }}>
...
//                 {index + 1}
//               </div>
//               <h4 className="text-lg font-bold text-white/90 mb-2 md:ml-5">{step.title}</h4>
//               <p className="text-sm text-[#7A8CA3] leading-[1.6] md:ml-5">{step.description}</p>
//             </article>
//           ))}
//         </div>
//       </div>
